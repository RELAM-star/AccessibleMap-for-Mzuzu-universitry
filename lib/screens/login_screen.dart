              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Hello!', style: TextStyle(color: Colors.white, fontSize: 48, fontWeight: FontWeight.w900, height: 1.1)),
                      Text('Welcome to AccessMap Mzuni', style: TextStyle(color: Colors.white.withOpacity(0.85), fontSize: 16)),
                    ],
                  ),
                ),
                Positioned(
